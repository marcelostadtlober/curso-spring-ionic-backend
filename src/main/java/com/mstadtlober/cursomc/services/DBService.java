...
import com.mstadtlober.cursomc.domain.Categoria;
...
import com.mstadtlober.cursomc.domain.Pagamento;
import com.mstadtlober.cursomc.domain.PagamentoComBoleto;
import com.mstadtlober.cursomc.domain.PagamentoComCartao;
import com.mstadtlober.cursomc.domain.Pedido;
import com.mstadtlober.cursomc.domain.Produto;
import com.mstadtlober.cursomc.domain.enums.EstadoPagamento;
import com.mstadtlober.cursomc.domain.enums.Perfil;
import com.mstadtlober.cursomc.domain.enums.TipoCliente;
import com.mstadtlober.cursomc.repositories.CategoriaRepository;
...
import com.mstadtlober.cursomc.repositories.EstadoRepository;
import com.mstadtlober.cursomc.repositories.ItemPedidoRepository;
import com.mstadtlober.cursomc.repositories.PagamentoRepository;
import com.mstadtlober.cursomc.repositories.PedidoRepository;
import com.mstadtlober.cursomc.repositories.ProdutoRepository;
...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "marcelostadtlober@gmail.com", "36378912377", TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli1.getTelefones().addAll(Arrays.asList("27363323", "93838393"));
		
		Cliente cli2 = new Cliente(null, "Ana Costa", "marcelostadtlober@yahoo.com.br", "54331157040", TipoCliente.PESSOAFISICA, pe.encode("123"));
		...
		enderecoRepository.save(Arrays.asList(e1, e2, e2));
